...
export default function AddTodo() {
  ...
  return (
    <div className="w-full flex justify-center items-center mb-4 sm:mb-6">
      <form onSubmit={addTodoHandler} className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 bg-gray-900 p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-lg w-full max-w-full sm:max-w-xl">
        <input
          type="text"
        ...
        >
          <span className="inline-flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 sm:w-5 h-4 sm:h-5">
